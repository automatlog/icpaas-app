...
// 8 tools per channel with optional badge
const TOOLS = (id, navigation) => [
  { icon: 'chatbubbles',          tint: '#10B981', tintBg: '#D1FAE5', label: 'Live Agent',  desc: 'Chat in real time',                   badge: '12 Active', onPress: () => navigation.navigate('Inbox') },
  { icon: 'megaphone',            tint: '#8B5CF6', tintBg: '#EDE9FE', label: 'Campaign',    desc: 'Create & manage campaigns',                                onPress: () => navigation.navigate('CampaignStep1') },
  { icon: 'flash',                tint: '#3B82F6', tintBg: '#DBEAFE', label: 'Automation',  desc: 'Automate workflows and auto-replies',                       onPress: () => {} },
  { icon: 'document-text',        tint: '#10B981', tintBg: '#D1FAE5', label: 'Templates',   desc: 'Manage message templates',                                  onPress: () => navigation.navigate('Templates') },
  { icon: 'people',               tint: '#8B5CF6', tintBg: '#EDE9FE', label: 'Contacts',    desc: 'Manage & segment contacts',                                 onPress: () => {} },
  { icon: 'bar-chart',            tint: '#EC4899', tintBg: '#FCE7F3', label: 'Reports',     desc: 'View analytics & performance',                              onPress: () => navigation.navigate('Report') },
  { icon: 'settings',             tint: '#3B82F6', tintBg: '#DBEAFE', label: 'Config',      desc: 'Manage channel preferences',                                onPress: () => navigation.navigate('Config') },
  { icon: 'code-slash',           tint: '#10B981', tintBg: '#D1FAE5', label: 'API Docs',    desc: `Integrate ${id.toUpperCase()} using our API`,               onPress: () => navigation.navigate('ApiDocs', { product: id }) },
];
